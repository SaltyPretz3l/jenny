...
const JENNY_SHELL_BRIDGE_DESCRIPTORS = Object.freeze({
  ...
  'projects.list': invokeMethod('projects:list'),
  'projects.create': invokeMethod('projects:create'),
  'projects.delete': invokeMethod('projects:delete'),
  'projects.rename': invokeMethod('projects:rename'),
  'projects.bindRoot': invokeMethod('projects:bind-root'),
  'projects.assignSession': invokeMethod('projects:assign-session'),
  'projects.adoptWorkspace': invokeMethod('projects:adopt-workspace'),
  'permissionReview.getState': invokeMethod('permission-review:get-state'),
  'permissionReview.resolve': invokeMethod('permission-review:resolve'),
  'sessionRuntime.getSnapshot': invokeMethod('session-runtime:get-snapshot'),
  'sessionRuntime.start': invokeMethod('session-runtime:start'),
  'sessionRuntime.submit': invokeMethod('session-runtime:submit'),
  'sessionRuntime.resume': invokeMethod('session-runtime:resume'),
  'sessionRuntime.pause': invokeMethod('session-runtime:pause'),
  'sessionRuntime.cancel': invokeMethod('session-runtime:cancel'),
  'sessionRuntime.updatePending': invokeMethod('session-runtime:update-pending'),
  'sessionRuntime.updateLimits': invokeMethod('session-runtime:update-limits'),
  'sessionRuntime.getResult': invokeMethod('session-runtime:get-result'),
  'sessionRuntime.getWork': invokeMethod('session-runtime:get-work'),
  ...
  'reminders.onFired': subscribeMethod('reminders:fired'),
  'reminders.onOpen': subscribeMethod('reminders:open'),
  'reminders.snooze': invokeMethod('reminders:snooze'),
  ...
  'workspaceRoot.prepareProject': invokeMethod('workspace-root:prepare-project'),
  ...
  'workspaceFs.readDocument': invokeMethod('workspace-fs:read-document'),
  'workspaceFs.writeText': invokeMethod('workspace-fs:write-text'),
  'workspaceFs.writeDocument': invokeMethod('workspace-fs:write-document'),
  ...
  'llamaServer.chooseRuntime': invokeMethod('llama-server:choose-runtime'),
  ...
  // pdfAddon.*: the optional PDF reading add-on (PyMuPDF, AGPL-3.0) in Settings >
  // Tools. install/installFromFile take exactly { licenseAccepted: true }; the
  // wheel for installFromFile comes from a main-owned dialog, never a renderer
  // path. Trusted-sender-authorized in services/main/pdf-addon-ipc-registration.js.
  'pdfAddon.getState': invokeMethod('pdf-addon:get-state'),
  'pdfAddon.install': invokeMethod('pdf-addon:install'),
  'pdfAddon.installFromFile': invokeMethod('pdf-addon:install-from-file'),
  'pdfAddon.cancel': invokeMethod('pdf-addon:cancel'),
  'pdfAddon.remove': invokeMethod('pdf-addon:remove'),
  'pdfAddon.onChanged': subscribeMethod('pdf-addon:changed'),
  'tools.list': invokeMethod('tools:list'),
  'tools.approve': invokeMethod('tools:approve'),
  'tools.buildAcceptedPlan': invokeMethod('tools:build-accepted-plan'),
