(function exposeJennyBackendStrings(globalScope, factory) {
  ...
  var ERROR_TEXT_BY_CODE = Object.freeze({
    'CMP-PROJECT-0001': function () { return jt('error.project.invalid', 'The stored project identity is invalid.'); },
    'CMP-PROJECT-0002': function () { return jt('error.project.notFound', 'The project or session could not be found.'); },
    'CMP-PROJECT-0003': function () { return jt('error.project.unavailable', 'Project storage or its workspace is unavailable.'); },
    'CMP-PROJECT-0004': function () { return jt('error.project.stale', 'Project access changed. Review the project before trying again.'); },
    ...
    'CMP-RUNTIME-0002': function () { return jt('runtime.ui.failedAction', 'The change could not be applied. Refresh and try again.'); },
    'CMP-RUNTIME-0003': function () { return jt('runtime.ui.failedAction', 'The change could not be applied. Refresh and try again.'); },
    'CMP-RUNTIME-0004': function () { return jt('runtime.ui.unavailable', 'Runtime information is unavailable.'); },
    'CMP-RUNTIME-0005': function () { return jt('runtime.ui.unavailable', 'Runtime information is unavailable.'); },
    'CMP-RUNTIME-0006': function () { return jt('runtime.ui.failedAction', 'The change could not be applied. Refresh and try again.'); },
    ...
    'CMP-TOOL-0047': function () { return jt('error.tool.pdfAddonMissing', 'PDF reading needs the optional PDF reading add-on. Install it in Settings › Tools › PDF reading add-on.'); },
    ...
    'CMP-WORKSPACEFS-0015': function () { return jt('error.workspaceFs.documentUnsupported', 'Only supported workspace documents (PDF, DOCX) can be opened as documents.'); },
    'CMP-WORKSPACEFS-0016': function () { return jt('error.workspaceFs.documentTooLarge', 'This document is larger than the document size limit.'); },
