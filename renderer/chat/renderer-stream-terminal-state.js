...
(function (root, factory) {
  ...
  const TERMINAL_PRESENTATION_MATRIX = Object.freeze({
    complete: freezePresentation({ status: 'completed', phase: 'completed', label: jt('chat.terminalState.completeLabel', 'Complete'), tone: 'success', actions: ['review_answer'], ariaLabel: jt('chat.terminalState.completeAriaLabel', 'Turn completed'), summary: jt('chat.terminalState.completeSummary', 'Turn complete.'), presenceState: 'complete', attentionLevel: 'quiet', priorityKind: 'review' }),
    error: freezePresentation({ status: 'errored', phase: 'error', label: jt('chat.terminalState.errorLabel', 'Needs Recovery'), tone: 'danger', actions: ['review_recovery'], ariaLabel: jt('chat.terminalState.errorAriaLabel', 'Turn ended with an error'), summary: jt('chat.terminalState.errorSummary', 'The turn needs recovery.'), presenceState: 'recovery', attentionLevel: 'urgent', priorityKind: 'recovery' }),
    cancelled: freezePresentation({ status: 'cancelled', phase: 'cancelled', label: jt('chat.terminalState.cancelledLabel', 'Cancelled'), tone: 'warning', actions: ['resume_or_review'], ariaLabel: jt('chat.terminalState.cancelledAriaLabel', 'Turn cancelled'), summary: jt('chat.terminalState.resumeOrReviewSummary', 'Resume or review the partial turn.'), presenceState: 'cancelled', attentionLevel: 'caution', priorityKind: 'resume' }),
    denied: freezePresentation({ status: 'denied', phase: 'error', label: jt('chat.terminalState.deniedLabel', 'Approval Denied'), tone: 'warning', actions: ['review_recovery'], ariaLabel: jt('chat.terminalState.deniedAriaLabel', 'Tool approval denied'), summary: jt('chat.terminalState.deniedSummary', 'The requested tool approval was denied.'), presenceState: 'recovery', attentionLevel: 'caution', priorityKind: 'recovery' }),
    timeout: freezePresentation({ status: 'timed_out', phase: 'error', label: jt('chat.terminalState.timeoutLabel', 'Timed Out'), tone: 'danger', actions: ['review_recovery'], ariaLabel: jt('chat.terminalState.timeoutAriaLabel', 'Turn timed out'), summary: jt('chat.terminalState.timeoutSummary', 'The turn timed out.'), presenceState: 'recovery', attentionLevel: 'urgent', priorityKind: 'recovery' }),
    interrupted: freezePresentation({ status: 'interrupted', phase: 'interrupted', label: jt('chat.terminalState.interruptedLabel', 'Interrupted'), tone: 'warning', actions: ['resume_or_review'], ariaLabel: jt('chat.terminalState.interruptedAriaLabel', 'Turn interrupted'), summary: jt('chat.terminalState.resumeOrReviewSummary', 'Resume or review the partial turn.'), presenceState: 'interrupted', attentionLevel: 'caution', priorityKind: 'resume' }),
    preempted: freezePresentation({ status: 'preempted', phase: 'interrupted', label: jt('chat.terminalState.preemptedLabel', 'Preempted'), tone: 'warning', actions: ['resume_or_review'], ariaLabel: jt('chat.terminalState.preemptedAriaLabel', 'Turn preempted'), summary: jt('chat.terminalState.preemptedSummary', 'The turn was stopped before it could finish.'), presenceState: 'interrupted', attentionLevel: 'caution', priorityKind: 'resume' }),
    unknown: freezePresentation({ status: 'unknown', phase: 'unknown', label: jt('chat.terminalState.unknownLabel', 'Status Unavailable'), tone: 'warning', actions: ['refresh_status'], ariaLabel: jt('chat.terminalState.unknownAriaLabel', 'Turn status unavailable'), summary: jt('chat.terminalState.unknownSummary', 'The terminal status is unavailable. Refresh or retry.'), presenceState: 'recovery', attentionLevel: 'caution', priorityKind: 'recovery' }),
  });
